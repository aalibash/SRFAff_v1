...
[outData.nImgsP, outData.nImgsN,outData.imgP_fp,outData.gtP_fp,...
    ...
    outData.gtN_fp,outData.rgbN_fp,outData.normN_fp, outData.curveN_fp]=deal(nImgsP, nImgsN, imgP_fp, gtP_fp,...
    rgbP_fp, normP_fp,curveP_fp, imgN_fp, gtN_fp, rgbN_fp, normN_fp, curveN_fp);
